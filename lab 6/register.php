<html>
<head>
    <title>Lab 6 - Register Page</title>
...
if(isset($_POST["submit"])) {
    ...
    $query = "INSERT INTO `users` (`u_mail`, `u_name`, `u_surname`, `u_phone`, `u_country`, `u_city`, `u_uni`, `u_password`) VALUES ('$u_mail', '$u_name', '$u_surname', '$u_phone', '$u_country', '$u_city', '$u_uni', '$u_password')";
    $result = $db -> query($query);
    if ($result) {
        echo "<br><br><br>Your account is created. You can login right now.";
    } else {
        echo "<br><br><br>Something wrong. Please try again.";
    }
}
?>
